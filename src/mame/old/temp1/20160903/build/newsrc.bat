...
copy /Y %from%\src\mame\drivers\taito_l.cpp         %to%\src\mame\drivers
copy /Y %from%\src\mame\drivers\thunderx.cpp        %to%\src\mame\drivers
copy /Y %from%\src\mame\drivers\toaplan1.cpp        %to%\src\mame\drivers
...
copy /Y %from%\src\mame\includes\toaplan1.h         %to%\src\mame\includes
copy /Y %from%\src\mame\includes\toaplan2.h         %to%\src\mame\includes
copy /Y %from%\src\mame\machine\toaplan1.cpp        %to%\src\mame\machine
...
copy /Y %from%\src\mame\video\toaplan1.cpp          %to%\src\mame\video
