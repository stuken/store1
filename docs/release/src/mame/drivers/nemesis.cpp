...
//          14318180/2, /* From schematics, should be accurate */
	...
	MCFG_AY8910_OUTPUT_TYPE(AY8910_LEGACY_OUTPUT) //MAMEFX
	MCFG_AY8910_PORT_A_READ_CB(READ8(*this, nemesis_state, nemesis_portA_r))
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.40) //MAMEFX
	...
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.00) //MAMEFX
	//MCFG_SOUND_ROUTE(0, "filter2", 1.00) //MAMEFX
	//MCFG_SOUND_ROUTE(1, "filter3", 1.00) //MAMEFX
	//MCFG_SOUND_ROUTE(2, "filter4", 1.00) //MAMEFX
...
MACHINE_CONFIG_START(nemesis_state::gx400)
	...
	MCFG_AY8910_OUTPUT_TYPE(AY8910_LEGACY_OUTPUT) //MAMEFX
	MCFG_AY8910_PORT_A_READ_CB(READ8(*this, nemesis_state, nemesis_portA_r))
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.30)

	MCFG_DEVICE_ADD("ay2", AY8910, 14318180/8)
	MCFG_AY8910_PORT_A_WRITE_CB(WRITE8("k005289", k005289_device, k005289_control_A_w))
	MCFG_AY8910_PORT_B_WRITE_CB(WRITE8("k005289", k005289_device, k005289_control_B_w))
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.60) //MAMEFX
	//MCFG_SOUND_ROUTE(0, "filter2", 1.00) //MAMEFX
	//MCFG_SOUND_ROUTE(1, "filter3", 1.00) //MAMEFX
	//MCFG_SOUND_ROUTE(2, "filter4", 1.00) //MAMEFX
	...
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.40) // MAMEFX
MACHINE_CONFIG_END
